-- COMPLETE DEPLOYMENT - Run this in Supabase SQL Editor
-- This fixes the 404 errors and creates missing tables
...
-- Insert sample tenant for your current tenant ID
INSERT INTO tenants (id, tenant_name, admin_email, subscription_status)
VALUES ('abbc6823-5d3f-42a9-a476-d33d8ec1ff6e', 'Sample Tenant', 'admin@example.com', 'active')
...
SELECT 'SUCCESS: Complete deployment finished! 🎯 All systems operational.' as status;