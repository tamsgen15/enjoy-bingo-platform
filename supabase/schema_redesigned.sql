...
-- Printed bingo cards table (pre-generated for numbers 1-100)
...
-- Players table (users select card numbers 1-100)
...
-- Admin actions table (track admin helping users)
...
-- Function to generate printed bingo card
...
DECLARE
  ...
  o_nums INTEGER[];
BEGIN
  -- Set seed for deterministic card generation
...
-- Generate all 100 printed bingo cards
DO $$
BEGIN
  FOR i IN 1..100 LOOP
