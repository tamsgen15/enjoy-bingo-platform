-- Enhanced function to safely call the next number with proper locking and validation
...
-- Clean up existing duplicates and add constraints
DO $$
BEGIN
...
-- Create helper function to get called numbers for a game
...
-- Create function to reset game state
